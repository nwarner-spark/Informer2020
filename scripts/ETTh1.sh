...
python -u main_informer.py --model informer --data ETTh1 --features M --seq_len 48 --label_len 48 --pred_len 24 --e_layers 2 --d_layers 1 --attn full --factor 3 --des $DES --itr $ITERS --gpu $GPU --encoder_type $ENC_TYPE --decoder_type $DEC_TYPE
